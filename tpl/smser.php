...
echo "<center>Message Status: Your message was sent successfully to $to ".print_r($out)."<br><a href=\"smser.php\"><b>Send New SMS Message</b></a></center>"; 
	...
	echo
	 ...
	 "<div id=\"stylized\" class=\"myform\">"
	   ."<form name=\"myform\" method=post action=\"".$_SERVER['PHP_SELF']."?option=sendsms\">"
	   ."<table border=\"0\">"
	   ."<tr>"
