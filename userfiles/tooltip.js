 ...
 * 2012-01-20 added by Kiran Pantha (Kiransoft)
 *
 * @version $Id: tooltip.js 10142 2012-03-20 10:32:13Z cybot_tm $
 */
...
function help()
{
alert('You can use [b]text[/b] for bold \n You can use [i]text[/i] for italic \n You can use [u]text[/u] for Underlined word \n You can use smilies like :-),:-(,:-o,:-O,[normal],[laugh],[cry],[cool],[small_blue],[laugh_blue]');
}
function call()
{
if (confirm('Information is about to be posted.\nCheck the data\n'+' Name:'+ques.name.value+' \nPasskey:'+ques.pass.value+' \nEmail:'+ques.email.value+' \nSubject:'+ques.subject.value+' \nQuestion:'+ques.message.value+'\n\n\nIs all correct'))
{
return true;
}
else
